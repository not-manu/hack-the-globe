...
const HIDE_NAV_PATHS = ['/listing/', '/chat/']
              ...
              if (item.isCenter) {
                return (
                  <button
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-primary-foreground transition-all active:scale-90"
                  >
